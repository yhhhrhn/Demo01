...
const (
	Task_GetTask_FullMethodName = "/poker.Task/GetTask"
)
...
func (c *taskClient) GetTask(ctx context.Context, in *TaskRequest, opts ...grpc.CallOption) (*TaskResponse, error) {
...
func (UnimplementedTaskServer) GetTask(context.Context, *TaskRequest) (*TaskResponse, error) {
...
func _Task_GetTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskServer).GetTask(ctx, req.(*TaskRequest))
	}
